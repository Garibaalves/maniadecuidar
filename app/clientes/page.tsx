...
export default function ClientesPage() {
  ...
  const handleDelete = async (id: string, name: string) => {
    const confirmed = window.confirm(`Deseja excluir o cliente ${name}?`);
    if (!confirmed) return;
    setDeletingId(id);
    setError(null);
    try {
  ...
  return (
    <AppShell>
      <PageHeader
        title="Clientes"
        description="Cadastro completo de clientes, dados de contato e enderecos."
        actions={(
          <>
            ...
            <Button variant="outline" asChild>
              <a href="/agendar">Agendar para cliente</a>
            </Button>
          </>
        )}
      />
