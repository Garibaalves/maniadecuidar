...
export default function ServicosPage() {
  ...
  const [form, setForm] = useState<FormState>({ ativo: true });
  ...
  return (
    <AppShell>
      <PageHeader
        title="Serviços"
        description="Cadastre, edite e ative/inative serviços oferecidos."
      />
          ...
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <div className="flex gap-2">
              <Input
                ...
                onBlur={loadServicos}
              />
              <Button variant="outline" onClick={loadServicos}>Atualizar</Button>
            </div>
          </CardHeader>
          <CardContent>
            {error && (
          ...
          <CardContent>
            <form className="space-y-3" onSubmit={handleSubmit}>
              <div className="space-y-2">
                <Label>Nome</Label>
                <Input
                  placeholder="Banho, Tosa, Hidratação"
                  value={form.nome ?? ""}
              ...
              <div className="flex gap-3">
                <Button type="submit" className="flex-1" disabled={saving}>
                  {saving ? "Salvando..." : editingId ? "Atualizar" : "Salvar serviço"}
                </Button>
                {editingId && (
                  <Button
                    type="button"
